...
# Link Do Front Mobile (PWA) [Van Escolar Front Mobile](https://secbus-app.flutterflow.app)

# Link Do video Mobile [Apresentação Mobile](https://youtu.be/fc2o4od0Vy4)
...
egurança e a eficiência do sistema. Como banco de dados, foi escolhido o H2 para armazenamento 
